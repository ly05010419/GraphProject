...
//		 Schnittstelle.showfordFulkerson();
	...
	public static void showCycleCanceling() throws Exception {
		...
		Graph graph1 = new Graph("./assets/kostenminimalFluss/KostenminimalTest.txt", true, true, true);
		algorithmus1.cycleCanceling(graph1);
...
//
//		Algorithmus algorithmus1 = new Algorithmus("./assets/Wege/Wege1.txt", true);
//		algorithmus1.dijkstra(2, 0);
//
//		Algorithmus algorithmus2 = new Algorithmus("./assets/Wege/Wege2.txt", true);
//		algorithmus2.mooreBellmanFord(2, 0,algorithmus2.graph);
//
//		Algorithmus algorithmus3 = new Algorithmus("./assets/Wege/Wege3.txt", true);
//		algorithmus3.mooreBellmanFord(2, 0,algorithmus2.graph);
//
//		Algorithmus algorithmus4 = new Algorithmus("./assets/MST/G_1_2.txt", true);
//		algorithmus4.mooreBellmanFord(0, 1,algorithmus2.graph);
//		
//		Algorithmus algorithmus6 = new Algorithmus("./assets/MST/G_1_2.txt", true);
//		algorithmus6.dijkstra(0, 1);
//
//		Algorithmus algorithmus5 = new Algorithmus("./assets/MST/G_1_2.txt", false);
//		algorithmus5.mooreBellmanFord(0, 1,algorithmus2.graph);
//		
//		Algorithmus algorithmus7 = new Algorithmus("./assets/MST/G_1_2.txt", false);
